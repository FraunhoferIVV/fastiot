...
sphinx-apidoc --module-first --ext-autodoc --ext-coverage --ext-todo -d 1 -o "docs/source/api/fastiot_core_services" "src/fastiot_core_services"
sphinx-apidoc --module-first --ext-autodoc --ext-coverage --ext-todo -d 1 -o "docs/source/api/fastiot" "src/fastiot"
